  ...
  return (
    <Card className="bg-podcast-dark border-gray-800 text-white h-fit">
      <CardContent className="pt-6">
        <h3 className="text-xl font-semibold mb-4 text-white">Détails de la Session</h3>
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center">
            ...
            <span className="px-4 py-2 mx-2 bg-podcast-dark rounded-md min-w-[60px] text-center">
              {duration} {duration === 1 ? 'heure' : 'heures'}
            </span>
            <Button 
              variant="outline" 
              size="sm" 
        ...
        <div className="mb-6">
          <label className="block text-gray-300 mb-2 flex items-center">
            <Users className="w-4 h-4 mr-2" /> Combien de personnes enregistreront ?
          </label>
          <div className="flex items-center">
            <Button 
              variant="outline" 
