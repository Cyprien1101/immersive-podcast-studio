      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {subscriptionPlans.map(plan => <Card key={plan.id} className={`booking-card relative ${plan.is_popular ? 'ring-2 ring-podcast-accent' : ''}`}>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {hourPackages.map(pkg => <Card key={pkg.id} className="booking-card">
                <CardHeader>
