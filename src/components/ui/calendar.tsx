  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-podcast-accent text-white hover:bg-podcast-accent hover:text-white focus:bg-podcast-accent focus:text-white ring-1 ring-black rounded-full",
        day_today: "bg-transparent text-white ring-1 ring-gray-700",
        day_outside:
